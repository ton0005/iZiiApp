...
-- Tables: sync_mutations, known_servers, devices, message_queue, notifications,
--         notification_settings, webhook_subscriptions, webhook_dead_letters,
--         enrollment_tokens, device_tokens, work_sessions, employee_pins
