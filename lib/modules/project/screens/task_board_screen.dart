            ...
            actions: [
              IconButton(
                ...
                onPressed: () {
                  context
                      .read<ProjectBloc>()
                      .add(LoadTasksEvent(widget.projectId));
                },
              ),
            ],
          ),
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${dialogContext.tr('project_task_title_label')} *',
              ...
              DropdownButtonFormField<String>(
                ...
                items: [
                  DropdownMenuItem(
                      value: 'low',
                      child: Text(dialogContext.tr('project_priority_low'))),
                  DropdownMenuItem(
                      value: 'medium',
                      child: Text(dialogContext.tr('project_priority_medium'))),
                  DropdownMenuItem(
                      value: 'high',
                      child: Text(dialogContext.tr('project_priority_high'))),
                ],
                onChanged: (val) {
                  if (val != null) {
                    setStateDialog(() {
